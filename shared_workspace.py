...
class Coordinator:
    ...
    def prompt(self, meta: dict, prompt: str) -> str:
        ...
        return (
            ...
            "Before returning, understand the intent and acceptance criteria, inspect every proposed "
            "line, run read-only checks where possible, critically review, and fix any issue you find. "
            "If evidence is incomplete, advise the lead with the exact blocker and next action. "
